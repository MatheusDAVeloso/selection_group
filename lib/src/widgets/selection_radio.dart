...
class SelectionRadio<T> extends StatelessWidget {
  ...
  /// When provided, the radio enters passive display mode — it becomes
  /// non-interactive and renders using these states instead of its own.
  ///
  /// Use this when the radio should mirror the state of a parent widget (e.g.
